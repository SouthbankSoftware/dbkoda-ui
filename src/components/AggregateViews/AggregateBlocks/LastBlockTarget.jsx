 ...
 * @Last modified time: 2018-05-25T14:03:22+10:00
 */
...
@observer
export default class LastBlockTarget extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return connectDropTarget(<li className="lastBlockTarget" />);
  }
}
