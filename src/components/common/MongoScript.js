...
(function(mod) {
  ...
  CodeMirror.defineMode('MongoScript', function(config, parserConfig) {
    ...
    var keywords = (function() {
      function kw(type, style) {
        return { type: type, style: style };
      }
      var A = kw('keyword a', 'keyword a');
      var B = kw('keyword b', 'keyword b');
      var C = kw('keyword c', 'keyword c');
      function MONGO(type) {
        return { type: 'keyword', style: type };
      }
      var OP = kw('operator', 'mongo-operator');
      ...
      var jsKeywords = {
        ...
        debugger: C,
        var: kw('var', 'keyword'),
        const: kw('var', 'keyword'),
        let: kw('var', 'keyword'),
        function: kw('function', 'keyword'),
        catch: kw('catch', 'keyword'),
        for: kw('for', 'keyword'),
        switch: kw('switch', 'keyword'),
        case: kw('case', 'keyword'),
        default: kw('default', 'keyword'),
        in: operator,
        typeof: operator,
        instanceof: operator,
        true: atom,
        ...
        class: kw('class', 'keyword'),
        super: kw('atom', 'keyword'),
        yield: C,
        export: kw('export', 'keyword'),
        import: kw('import', 'keyword'),
        extends: C,
        await: C,
