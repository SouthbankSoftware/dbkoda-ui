      ...
      <nav className="pt-navbar profileListToolbar">
        <div className="pt-navbar-group pt-align-left">
          <div className="pt-button-group">
            <Alert className="pt-dark" intent={Intent.PRIMARY} isOpen={this.state.closeConnectionAlert}
            ...
            <Alert className="pt-dark" intent={Intent.PRIMARY} isOpen={this.state.removeConnectionAlert}
