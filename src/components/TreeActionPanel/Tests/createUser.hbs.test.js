...
const templateToBeTested = '../Templates/CreateUser.hbs';
const inputForTheTemplate = './CreateUser.hbs.input.json';
...
const dropUserCmd = sprintf('db.getSiblingDB("admin").dropUser( \
    "%s",{w: "majority"}) ;\n', randomUser);
