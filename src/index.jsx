 ...
 * @Last modified time: 2018-07-03T17:02:26+10:00
 *
...
if (IS_ELECTRON) {
  ...
  ipcRenderer.on('shouldShowConfirmationDialog', () => {
    ipcRenderer.send(
      ...
      UAT ? false : store.hasUnsavedEditorTabs()
    );
  });

  ipcRenderer.on('windowClosing', () => {
    l.notice('executing app closing logic...');
...
window.onbeforeunload = () => {
  l.notice('executing app refreshing logic...');
